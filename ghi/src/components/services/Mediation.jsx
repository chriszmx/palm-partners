              ...
              <div className="px-6 lg:contents">
                  <div className="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-xxl lg:flex-none lg:pt-32 xl:w-1/2 xl:pl-10">
                      ...
                      <p className="mt-6 text-xl leading-8 text-gray-700">
                          ...
                          compensation. We navigate the intricacies of insurance
                          policies and stand firm in negotiations on your
                          behalf.
                      </p>
                      <div className="mt-10 max-w-xl text-base leading-7 text-gray-700 lg:max-w-none">
                          <p>
                              Our approach to mediation is strategic and
                              empathetic, ensuring that your voice is heard and
                              your interests are prioritized. We understand that
                              the aftermath of property damage can be stressful,
                              which is why we strive to make the claims process
                              as smooth as possible for our clients in Florida.
                          </p>
                          <ul
                              role="list"
                          ...
                          >
                              ...
                              <li className="flex gap-x-3">
                                  ...
                                  <span>
                                      ...
                                      way, providing clarity and understanding.
                                  </span>
                              </li>
                          </ul>
                          <p className="mt-8">
                              ...
                              handled with the utmost care and precision. Choose
                              us for peace of mind and the compensation you
                              deserve.
                          </p>
                          ...
                          <p className="mt-6">
                              ...
                              importance of a fair claim settlement. Trust Palm
                              Partners to be your ally in navigating the
