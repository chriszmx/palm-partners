...
export default function Matterport() {
  return (
    <div className="relative bg-white">
      <Helmet>
        <title>Maximize Your Claim with Palm Partners' 4D Home Design Technology</title>
        <meta name="description" content="Enhance your property insurance claims with Palm Partners' Matterport technology. Maximize settlements with precise 4D home deign imaging." />
        <link rel="canonical" href="https://palmpts.com/services/matterport" />
      </Helmet>
