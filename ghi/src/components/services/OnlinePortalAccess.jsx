                ...
                <div className="px-6 lg:contents">
                    <div className="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-xxl lg:flex-none lg:pt-32 xl:w-1/2 xl:pl-10">
                        ...
                        <p className="mt-6 text-xl leading-8 text-gray-700">
                            Our intuitive online portal keeps you in the loop
                            with real-time updates and comprehensive insights
                            into your claim's progress. Experience unparalleled
                            transparency and control with Palm Partners'
                            innovative claim tracking technology.
                        </p>
                        <div className="mt-10 max-w-xl text-base leading-7 text-gray-700 lg:max-w-none">
                            <p>
                                Our platform is designed to simplify the claim
                                process, offering you a user-friendly interface
                                to view documents, communicate with your
                                adjuster, and monitor settlement negotiations.
                                Empower yourself with all the information you
                            ...
                            >
                                <li className="flex gap-x-3">
                                    ...
                                    <span>
                                        ...
                                        Log in from any device, anywhere, to
                                        check the status of your claim, ensuring
                                        you're always informed and up-to-date.
                                    </span>
                                </li>
                                <li className="flex gap-x-3">
                                    <DocumentTextIcon
                            ...
                            <p className="mt-8">
                                ...
                                commitment to clear communication and
                                exceptional service. Our online portal is just
                                one of the many ways we ensure you're supported
                                every step of the way towards a fair settlement.
                            </p>
                        </div>
