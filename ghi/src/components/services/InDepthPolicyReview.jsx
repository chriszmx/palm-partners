                ...
                <div className="px-6 lg:contents">
                    <div className="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-xxl lg:flex-none lg:pt-32 xl:w-1/2 xl:pl-10">
                        ...
                        <p className="mt-6 text-xl leading-8 text-gray-700">
                            ...
                            vital to ensuring you're fully covered. Our
                            meticulous policy review process demystifies complex
                            terms and maximizes your benefits.
                        </p>
                        <div className="mt-10 max-w-xl text-base leading-7 text-gray-700 lg:max-w-none">
                            <p>
                                At Palm Partners, we delve into the nuances of
                                your policy, ensuring you're not blindsided by
                                exclusions or limitations. Our Florida-based
                                team brings clarity to your coverage, empowering
                            ...
                            >
                                <li className="flex gap-x-3">
                                    ...
                                    <span>
                                        ...
                                        scrutinize every aspect of your policy
                                        to uncover hidden coverage
                                        opportunities.
                                    </span>
                                </li>
                                <li className="flex gap-x-3">
                                    ...
                                    <span>
                                        ...
                                        We identify potential risks and advise
                                        on the best strategies to fortify your
                                        insurance defense.
                                    </span>
                                </li>
                                <li className="flex gap-x-3">
                                    ...
                                    <span>
                                        ...
                                        Our negotiation prowess ensures that
                                        your claim settlements are just and
                                        equitable.
                                    </span>
                                </li>
                            </ul>
                            <p className="mt-8">
                                ...
                                works tirelessly to provide you with a
                                transparent and thorough policy understanding.
                            </p>
                            <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">
                                Your Trusted Policy Ally
                            </h2>
                            <p className="mt-6">
                                With Palm Partners, you're not just reading
                                lines of text; you're uncovering the full
                                potential of your policy. Let us navigate the
                                complexities and advocate for your maximum
                                benefit.
                            </p>
                        </div>
